  ...
  <div class="Slider" :class="sliderClasses">
    <div ref="list" class="Slider__list">
      ...
      >
        ...
        <div
          :class="['Slider__slides', 'Slider__slides--regular', settings.extraClass]"
          ref="slides"
        >
          <slot />
        </div>
    ...
    >
      <button
        ...
        :class="settings.navButtons && !settings.disabled ? '' : 'invisible'"
  ...
  computed: {
    ...
    allSlides() {
      if (this.clonedSlides)
        return [...this.slidesClonedBefore, ...this.slides, ...this.slidesClonedAfter]
      return this.slides
    },
    slidesCount() {
  ...
  methods: {
    ...
    goToNext() {
      if (this.canGoToNext) {
        ...
        if (this.currentSlide + this.settings.slidesToScroll > this.slidesCount) {
          this.$emit('load-more')
        }
      }
    },
